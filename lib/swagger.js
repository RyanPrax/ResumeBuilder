    ...
    paths: {
        ...
        "/contact": {
            get: {
                ...
                responses: {
                    200: {
                        description:
                            "Contact record (always one-element array)",
                        content: {
                            "application/json": {
                                schema: {
                                    type: "array",
            ...
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/BulletInput",
                            },
                        },
                    },
                },
        ...
        "/jobs/{id}/bullets/{bid}": {
            put: {
                ...
                parameters: [
                    ...
                    { $ref: "#/components/parameters/BidParam" },
                ],
                requestBody: {
                    required: true,
                    content: {
        ...
        "/awards": {
            ...
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: { $ref: "#/components/schemas/AwardInput" },
                        },
                    },
                },
                responses: {
        ...
        "/resumes/{id}/selections": {
            put: {
                tags: ["Resumes"],
                summary:
                    "Bulk upsert sections, items, and bullets for a resume",
                parameters: [{ $ref: "#/components/parameters/IdParam" }],
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/ResumeSelections",
                            },
                        },
                    },
                },
            ...
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/AiReviewInput",
                            },
                        },
                    },
                },
                responses: {
                    200: {
                        ...
                        content: {
                            "application/json": {
                                schema: {
                                    $ref: "#/components/schemas/AiReviewResponse",
                                },
                            },
                        },
                    },
                    400: {
                        description: "Missing key or invalid input",
                        content: {
                            "application/json": {
                                schema: {
                                    $ref: "#/components/schemas/ErrorResponse",
